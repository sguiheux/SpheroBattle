 ...
 * method, and call this View's {@link #interpretMotionEvent(MotionEvent)} method, passing the
 * MotionEvent to it:
 * <pre>{@code
 *
 ...
 * override the {@link #onRotationStarted(Point, Point)},
 * {@link #onRotation(double, Point, Point)}, and
 * {@link #onRotationEnded(double, Point, Point)} for even more control over these
 * events.
 * </p>
 * <p>
...
public class CalibrationView extends WidgetGraphicView implements Controller {
     ...
     * {@link #CalibrationView(Context, AttributeSet)} with a
     * null AttributeSet.
     *
     * @param context The Android Context
     * @see #CalibrationView(Context, AttributeSet)
     */
    ...
    private class RotationGestureDetector extends CalibrationGestureDetector implements CalibrationGestureDetector.RotationEventListener {
        ...
        /**
         * To be called each time your {@link View} receives a touch event from
         * {@link View#onTouchEvent(MotionEvent)}. This will enable rotation gesture detection
         * on this view. If you would like the rotation gesture to be global, you can call this in your activity's
         * {@link android.app.Activity#dispatchTouchEvent(MotionEvent)}.
         *
         * @param event the {@link MotionEvent} from the {@link View}'s
         *              {@link View#onTouchEvent(MotionEvent)} method.
